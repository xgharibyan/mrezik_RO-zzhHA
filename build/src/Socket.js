System.register(['rodin/core', './Character.js', './Screen.js', './initialPositions.js', 'rodin/modules'], function (_export, _context) {
    "use strict";

    var RODIN, Character, screen, initialPositions, Modules;
    return {
        ...
        }, function (_rodinModules) {
            Modules = _rodinModules;
        }],
        execute: function () {
